...
public class Form_MonitoringJournal extends AbstractForm {
  ...
  protected FramedPanel panelMain() {
    ...
    radioMiddlePerTanggalTransaksiSemuaTransaksi
        .setBoxLabel("Per Tanggal Transaksi Semua Transaksi");
    p2_0.add(radioMiddlePerTanggalTransaksiSemuaTransaksi);

    Radio radioMiddlePerTanggalBukuSemuaTransaksiPerKogol = new Radio();
    radioMiddlePerTanggalBukuSemuaTransaksiPerKogol
        .setBoxLabel("Per Tanggal Buku Semua Transaksi Per Kogol");
    ...
    radioMiddlePerTanggalTransaksiSemuaTransaksiPerKogol
        .setBoxLabel("Per Tanggal Transaksi Semua Transaksi Per Kogol");
    ...
    radioMiddlePerTanggalBukuSemuaTransaksiPerKogolPerJnsRek
        .setBoxLabel("Per Tanggal Buku Semua Transaksi Per Kogol Per Jns Rek");
    ...
    radioMiddlePerTanggalTransaksiSemuaTransaksiPerKogolPerJnsRek
        .setBoxLabel("Per Tanggal Transaksi Semua Transaksi Per Kogol Per Jns Rek");
    ...
    radioMiddlePerTanggalBukuSemuaTransaksiGerakTransaksi
        .setBoxLabel("Per Tanggal Buku Semua Transaksi (Gerak Transaksi)");
    ...
    radioMiddlePerTanggalTransaksiSemuaTransaksiGerakTransaksi
        .setBoxLabel("Per Tanggal Transaksi Semua Transaksi (Gerak Transaksi)");
    ...
    radioMiddlePerTanggalBukuSemuaTransaksiPerKogolGerakTransaksi
        .setBoxLabel("Per Tanggal Buku Semua Transaksi Per Kogol (Gerak Transaksi)");
    ...
    radioMiddlePerTanggalTransaksiSemuaTransaksiPerKogolGerakTransaksi
        .setBoxLabel("Per Tanggal Transaksi Semua Transaksi Per Kogol (Gerak Transaksi)");
    ...
    radioMiddlePerTanggalBukuSemuaTransaksiPerKogolPerJnsRekGerakTransaksi
        .setBoxLabel("Per Tanggal Buku Semua Transaksi Per Kogol Per Jns Rek (Gerak Transaksi)");
    ...
    radioMiddlePerTanggalTransaksiSemuaTransaksiPerKogolPerJnsRekGerakTransaksi
        .setBoxLabel("Per Tanggal Transaksi Semua Transaksi Per Kogol Per Jns Rek (Gerak Transaksi)");
