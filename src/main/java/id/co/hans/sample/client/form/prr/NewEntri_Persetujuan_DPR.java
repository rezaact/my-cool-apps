...
public class NewEntri_Persetujuan_DPR {
...
//        progressBox.setProgressText("wait...");
    ...
    private FramedPanel panelMain() {
        ...
        panel.setHeadingText("Persetujuan DPR");
        ...
        bttnReset = new TextButton("Reset");
        toolBar.add(bttnReset);
        ...
        gpData.addColumn("NO_BA_DPR", 100);
