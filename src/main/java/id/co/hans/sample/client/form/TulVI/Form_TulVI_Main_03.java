...
public class Form_TulVI_Main_03 {
    ...
    private FramedPanel panelMain() {
        ...
        panel.setHeadingText("Cetak Pembongkaran (Tul VI-03)");
                            ...
                            panelCenterPilihKriteria.setHeight(480);
                                ...
                                vlcPanelCenterPilihKriteria.add(hpPanelCenterPilihKriteria_line16);
                                    ...
                                    HorizontalPanel hpPanelCenterPilihKriteria_line17 = new HorizontalPanel();
                                        ...
                                        Label lblPanelCenterPilihKriteria_line17_desc = new Label("Petugas Pembongkaran :");
...
//                            panelCenterRight.setHeadingText("Pilih Proses");
                            ...
                            panelCenterRight.setHeight(559);
                                ...
                                VerticalLayoutContainer vlcPanelCenterRight = new VerticalLayoutContainer();
                                    ...
                                    panelCenterRight_PilihProses.setHeight(233);
                                        ...
                                        VerticalLayoutContainer vlcPanelCenterRight_PilihProses = new VerticalLayoutContainer();
                                            ...
                                            HorizontalPanel hpVlcPanelCenterRight_PilihProses_Radios1 = new HorizontalPanel();
                                                ...
                                                radioTopPembongkaran.setBoxLabel("Cetak Tul VI-03");
                                                radioTopPembongkaran.setValue(true);

                                                Radio radioTopPembongkaran_ulang = new Radio();
                                                radioTopPembongkaran_ulang.setBoxLabel("Cetak Ulang Tul VI-03");

                                            hpVlcPanelCenterRight_PilihProses_Radios1.add(radioTopPembongkaran);
                                            hpVlcPanelCenterRight_PilihProses_Radios1.add(radioTopPembongkaran_ulang);
                                        ...
                                        vlcPanelCenterRight_PilihProses.add(hpVlcPanelCenterRight_PilihProses_Radios1);
                                            ...
                                            HorizontalPanel hpVlcPanelCenterRight_PilihProses_Radios2 = new HorizontalPanel();
                                                ...
                                                Radio radioTopPembongkaran_PK = new Radio();
                                                radioTopPembongkaran_PK.setBoxLabel("Cetak PK Bongkar");

                                                Radio radioTopPembongkaran_PK_Ulang = new Radio();
                                                radioTopPembongkaran_PK_Ulang.setBoxLabel("Cetak Ulang PK Bongkar");

                                            hpVlcPanelCenterRight_PilihProses_Radios2.add(radioTopPembongkaran_PK);
                                            hpVlcPanelCenterRight_PilihProses_Radios2.add(radioTopPembongkaran_PK_Ulang);

                                        vlcPanelCenterRight_PilihProses.add(hpVlcPanelCenterRight_PilihProses_Radios2);

                                            HorizontalPanel hpVlcPanelCenterRight_PilihProses_Radios3 = new HorizontalPanel();

                                                Radio radioTopPembongkaran_BA = new Radio();
                                                radioTopPembongkaran_BA.setBoxLabel("Cetak BA Bongkar");

                                                Radio radioTopPembongkaran_BA_Ulang = new Radio();
                                                radioTopPembongkaran_BA_Ulang.setBoxLabel("Cetak Ulang BA Bongkar");

                                                ToggleGroup tgHpVlcPanelCenterRight_PilihProses_Radios = new ToggleGroup();
                                                tgHpVlcPanelCenterRight_PilihProses_Radios.add(radioTopPembongkaran);
                                                tgHpVlcPanelCenterRight_PilihProses_Radios.add(radioTopPembongkaran_ulang);
                                                tgHpVlcPanelCenterRight_PilihProses_Radios.add(radioTopPembongkaran_PK);
                                                tgHpVlcPanelCenterRight_PilihProses_Radios.add(radioTopPembongkaran_PK_Ulang);
                                                tgHpVlcPanelCenterRight_PilihProses_Radios.add(radioTopPembongkaran_BA);
                                                tgHpVlcPanelCenterRight_PilihProses_Radios.add(radioTopPembongkaran_BA_Ulang);

                                            hpVlcPanelCenterRight_PilihProses_Radios3.add(radioTopPembongkaran_BA);
                                            hpVlcPanelCenterRight_PilihProses_Radios3.add(radioTopPembongkaran_BA_Ulang);

                                        vlcPanelCenterRight_PilihProses.add(hpVlcPanelCenterRight_PilihProses_Radios3);
                                ...
                                vlcPanelCenterRight.add(panelCenterMiddle);
                                    ...
                                    panelCenterBottom.setHeight(177);
