...
public class Form_TulV08 {
    ...
    private FramedPanel panelMain() {
        ...
        panel.setHeadingText("Laporan V-08");
        ...
        TextButton btnSah = new TextButton("Pengesahan Satker");
        TextButton btnReport = new TextButton("Daftar Pengesahan tk Satker");

        panelReferensi.addButton(btnSah);
        panelReferensi.addButton(btnReport);
