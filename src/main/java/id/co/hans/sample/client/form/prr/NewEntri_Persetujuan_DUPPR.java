...
public class NewEntri_Persetujuan_DUPPR {
    ...
    private TextButton bttnSimpan, bttnFilter, bttnReset;
...
//        progressBox.setProgressText("wait...");
    ...
    private FramedPanel panelMain() {
        ...
        panel.setHeadingText("Persetujuan DUPPR");
        ...
        TextField tSUPPRPus = new TextField();

        hp.add(tSUPPRPus);

        vlc.add(new FieldLabel(hp, "No SUPPR PUSAT"));

        vlc = new VerticalLayoutContainer();

        hp = new HorizontalPanel();

        DateField dTglHapusDUPPR = new DateField();

        hp.add(dTglHapusDUPPR);

        vlc.add(new FieldLabel(hp, "Tanggal Penghapusan"));
