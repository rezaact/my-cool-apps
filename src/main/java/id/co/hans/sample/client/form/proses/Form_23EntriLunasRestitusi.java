...
public class Form_23EntriLunasRestitusi {
    ...
    private FramedPanel panelMain() {
        ...
        TextButton bTopReset = new TextButton("Reset");
        bTopReset.setEnabled(false);
        bTopReset.setWidth(100);
        TextButton bTopSimpan = new TextButton("Simpan");
        bTopSimpan.setEnabled(false);
        bTopSimpan.setWidth(100);
        TextButton bTopCetakKw = new TextButton("Reset");
        bTopCetakKw.setEnabled(false);
        bTopCetakKw.setWidth(100);
        toolBar.add(bTopReset);
        toolBar.add(bTopSimpan);
        toolBar.add(bTopCetakKw);
        ...
        hp0.add(new FieldLabel(new Label("*( Tanggal Pelunasan untuk flagging lunas adalah sysdate"), "Keterangan"));
        FieldBawah.add(hp0);
        p.add(fieldSet1);
