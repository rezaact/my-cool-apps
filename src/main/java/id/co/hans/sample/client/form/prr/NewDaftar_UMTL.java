...
//        progressBox.setProgressText("wait...");
    ...
    private FramedPanel panelMain() {
        ...
        panel.setHeadingText("Daftar UMTL");
        ...
        vlcTanggal.add(new FieldLabel(hp, "Tanggal Bayar"));
        ...
        gpData.addColumn("TGLBAYAR", 100);
        gpData.addColumn("IDPEL", 100);
        gpData.addColumn("KDGERAKKELUAR", 100);
        ...
        gpData.addColumn("JALANTUNGGAK", 100);
