...
public class ComboUnsurLaporan404 extends AbstractComboComponent {
    ...
    public Widget asWidget() {
        cb = new IconComboBox();
        cb.setStoreUrl("components/getComboDataUnsur404.json");
        cb.setComboWidth(79);
        ...
        return new FieldLabel(hp, "Unsur Laporan IV-04");
    }
}
