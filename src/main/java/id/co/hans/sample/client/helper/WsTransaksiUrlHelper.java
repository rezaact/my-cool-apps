...
/**
 * Kelas Helper Untuk membentuk url yang mengarah kepada WS TRANSAKSI Restful
 * Service
 * 
...
public class WsTransaksiUrlHelper {
	...
	private static final String TANGGAL_HARI_INI = WS_TRANSAKSI_PREFIX
			+ "ambilTanggalHariIni.json";
	private static final String MASTER_UNIT = WS_TRANSAKSI_PREFIX
			+ "getMasterUnit.json";
	...
	public String getMonitoringUploadSorekURL(String unit, String blth,
			String satuan) {
		UrlBuilder builder = new UrlBuilder();
