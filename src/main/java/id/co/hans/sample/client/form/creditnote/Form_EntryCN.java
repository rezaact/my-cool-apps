...
public class Form_EntryCN extends AbstractForm {
	...
	private FramedPanel center() {
		...
		// todo: add label
		// "Masukkan Penyetoran Uang ke Bank berdasarkan Unsur Rekening :"
		...
		p.add(new FieldLabel(tfKodeBank01, "Kode Bank 01"),
				new VerticalLayoutContainer.VerticalLayoutData(1, -1));
		...
		p.add(new FieldLabel(tfKodeBank02, "Kode Bank 02"),
				new VerticalLayoutContainer.VerticalLayoutData(1, -1));
		...
		p.add(new FieldLabel(tfKodeBank03, "Kode Bank 03"),
				new VerticalLayoutContainer.VerticalLayoutData(1, -1));
		...
		p.add(new FieldLabel(tfKodeBank04, "Kode Bank 04"),
				new VerticalLayoutContainer.VerticalLayoutData(1, -1));
		...
		p.add(new FieldLabel(tfKodeBank05, "Kode Bank 05"),
				new VerticalLayoutContainer.VerticalLayoutData(1, -1));
		...
		p.add(new FieldLabel(tfKodeBank06, "Kode Bank 06"),
				new VerticalLayoutContainer.VerticalLayoutData(1, -1));
		...
		p.add(new FieldLabel(tfKodeBank07, "Kode Bank 07"),
				new VerticalLayoutContainer.VerticalLayoutData(1, -1));
		...
		p.add(new FieldLabel(cnPtl, "cnPtl"),
				new VerticalLayoutContainer.VerticalLayoutData(1, -1));
		...
		p.add(new FieldLabel(lembar, "Lembar"),
				new VerticalLayoutContainer.VerticalLayoutData(1, -1));
		...
		p.add(new FieldLabel(rpTag, "Lembar"),
				new VerticalLayoutContainer.VerticalLayoutData(1, -1));
	...
	protected void initEvent() {
		...
		cb_UnitUP
				.addSelectionHandler(new SelectionHandler<Map<String, String>>() {

					@Override
					public void onSelection(
							SelectionEvent<Map<String, String>> event) {
		...
		btn_Buat.addSelectHandler(new SelectEvent.SelectHandler() {
			 ...
			 * cb_KodePP.SelectedItem.Text & "/" & Format(dt_Pelunasan.Value,
			 * "yyyyMMdd") & "/" & Format(dt_Penyetoran.Value, "yyyyMMdd") & ""
			 */
			@Override
			public void onSelect(SelectEvent event) {
				StringBuilder kodeBuktiSetor = new StringBuilder(
						BUKTI_SETOR_PREFIX_CODE);
				kodeBuktiSetor
						.append(cb_UnitUP.getComboBox().getSelectedText())
						.append(BUKTI_SETOR_SEPARATOR)
						.append(cb_KodePP.getComboBox().getSelectedText())
						.append(BUKTI_SETOR_SEPARATOR)
						.append(DateTimeFormat.getFormat("yyyyMMdd").format(
								dt_Pelunasan.getValue()))
						.append(BUKTI_SETOR_SEPARATOR)
						.append(DateTimeFormat.getFormat("yyyyMMdd").format(
								dt_Penyetoran.getValue())).append("");
		...
		btn_Simpan.addSelectHandler(new SelectEvent.SelectHandler() {
			...
			public void onSelect(SelectEvent event) {
				...
				String dsValue = "{}";
				dsJsonObject.put("ds",
						new JSONObject(JsonUtils.safeEval(dsValue)));
				sendRequest(RequestBuilder.GET,
						WsUmumUrlHelper.getTanggalDatabaseURL(), null,
						new RequestCallback() {
	...
	protected FramedPanel panelMain() {
		...
		p.add(new FieldLabel(txt_UnitUP, "Unit UP"),
				new VerticalLayoutContainer.VerticalLayoutData(1, -1));
		...
		p.add(new FieldLabel(txt_KodePp, "Kode PP"),
				new VerticalLayoutContainer.VerticalLayoutData(1, -1));
		...
		p.add(new FieldLabel(tfTopPilihKodePp, "Kode PP"),
				new VerticalLayoutContainer.VerticalLayoutData(1, -1));

		dt_Pelunasan = new DateField();
		dt_Pelunasan.setAllowBlank(false);
		p.add(new FieldLabel(dt_Pelunasan, "Tanggal Pelunasan"),
				new VerticalLayoutContainer.VerticalLayoutData(1, -1));

		dt_Penyetoran = new DateField();
		dt_Penyetoran.setAllowBlank(false);
		p.add(new FieldLabel(dt_Penyetoran, "Tanggal Penyetoran"),
				new VerticalLayoutContainer.VerticalLayoutData(1, -1));

		txt_BABuktiSetor = new TextField();
		txt_BABuktiSetor.setAllowBlank(false);
		p.add(new FieldLabel(txt_BABuktiSetor, "Nomor BA Bukti Setor"),
				new VerticalLayoutContainer.VerticalLayoutData(1, -1));
