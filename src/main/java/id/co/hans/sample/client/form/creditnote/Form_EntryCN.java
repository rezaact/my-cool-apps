...
public class Form_EntryCN extends AbstractForm {
  ...
  private FramedPanel center() {
    ...
    p.add(new FieldLabel(rpMaterai, "Materai"), new VerticalLayoutContainer.VerticalLayoutData(1,
        -1));
    ...
    p.add(new FieldLabel(cnMaterai, "Materai"), new VerticalLayoutContainer.VerticalLayoutData(1,
        -1));
  ...
  protected void initEvent() {
    ...
    btn_Buat.addSelectHandler(new SelectEvent.SelectHandler() {
      /*
       * "BACN-" & cb_UnitUP.SelectedItem.Text & "/" & cb_KodePP.SelectedItem.Text & "/" &
       * Format(dt_Pelunasan.Value, "yyyyMMdd") & "/" & Format(dt_Penyetoran.Value, "yyyyMMdd") & ""
       */
      @Override
      public void onSelect(SelectEvent event) {
        StringBuilder kodeBuktiSetor = new StringBuilder(BUKTI_SETOR_PREFIX_CODE);
        kodeBuktiSetor.append(cb_UnitUP.getComboBox().getSelectedText())
            .append(BUKTI_SETOR_SEPARATOR).append(cb_KodePP.getComboBox().getSelectedText())
  ...
  protected FramedPanel panelMain() {
    ...
    p.add(new FieldLabel(txt_UnitUP, "Unit UP"), new VerticalLayoutContainer.VerticalLayoutData(1,
        -1));
    ...
    p.add(new FieldLabel(txt_KodePp, "Kode PP"), new VerticalLayoutContainer.VerticalLayoutData(1,
        -1));
