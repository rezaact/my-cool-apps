...
public class Form_31Idpel   {
    ...
    private FramedPanel panelMain() {
        ...
        FieldAtas.add(new FieldLabel(IDPel, "ID Pelanggan"));
        ...
        hp2.add(new FieldLabel(tTRpBK1, "Rp BK 1"), new BoxLayoutData(new Margins(0, 5, 0, 0)));
        VTab.add(hp2);
        ...
        hp2.add(new FieldLabel(tTRpBK2, "Rp BK 2"), new BoxLayoutData(new Margins(0, 5, 0, 0)));
        VTab.add(hp2);
        ...
        hp2.add(new FieldLabel(tTRpBK3, "Rp BK 3"), new BoxLayoutData(new Margins(0, 5, 0, 0)));
        VTab.add(hp2);
        ...
        gpDataCN.setGridDimension(780, 200);
        gpDataCN.setStoreUrl("BasicProject/thuGetString.json?name=store1");
        gpDataCN.addColumn("Simpan", 50);
        gpDataCN.addColumn("Hasil", 50);
        gpDataCN.addColumn("Nomor", 50);
        gpDataCN.addColumn("IDPEL", 100);
        gpDataCN.addColumn("BLTH", 80);
        gpDataCN.addColumn("RPTAG", 100);
        gpDataCN.addColumn("RPBK", 100);
        gpDataCN.addColumn("TGLUTTEMPO", 100);
        gpDataCN.addColumn("STATUS", 100);
        gpDataCN.addColumn("KDPEMPP", 100);
        gpDataCN.addColumn("KDGERAKAN", 100);
