...
public class WsUmumUrlHelper {
	...
	private static final String REF_AMBIL_PETUGAS = WS_UMUM_PREFIX
			+ "ref_AmbilPetugas.json";
	private static final String AMBIL_NAMA_AP_DARI_UP = WS_UMUM_PREFIX
			+ "ambilNamaApdariUp.json";
	private static final String AMBIL_NAMA_KD_DARI_UP = WS_UMUM_PREFIX
			+ "ambilNamaKddariUp.json";
	private static final String AMBIL_NAMA_KD_DARI_AP = WS_UMUM_PREFIX
			+ "ambilNamaKddariAP.json";
	private static final String AMBIL_NAMA_AP = WS_UMUM_PREFIX
			+ "ambilNamaAP.json";
	private static final String AMBIL_ALAMAT_DARI_UP = WS_UMUM_PREFIX
			+ "ambilAlamatdariUp.json";
	...
	private static final String GET_PIUTANG_INFO = WS_UMUM_PREFIX
			+ "getPiutangInfo.json";
	private static final String GET_PELUNASAN_INDIVIDU = WS_UMUM_PREFIX
			+ "getPelunasanIndividu.json";
	...
	private static final String CARI_IDPEL_INDIVIDU = WS_UMUM_PREFIX
			+ "cariPelIndividu.json";
	...
	private static final String GET_DPP_INDIVIDU = WS_UMUM_PREFIX
			+ "getDPPIndividu.json";
	private static final String CON_ORACLE = WS_UMUM_PREFIX + "ConnOracle.json";
	private static final String CARI_DIL_INFO = WS_UMUM_PREFIX
			+ "caridilinfo.json";
	private static final String CAR_DPP_INFO = WS_UMUM_PREFIX
			+ "carDPPInfo.json";
	private static final String GET_KODE_SIKLIS = WS_UMUM_PREFIX
			+ "ambilKodesiklis.json";
	private static final String AMBIL_PEJABAT_ID01 = WS_UMUM_PREFIX
			+ "ambilPejabatID01.json";
	private static final String AMBIL_PEJABAT_ID02 = WS_UMUM_PREFIX
			+ "ambilPejabatID02.json";
	private static final String CETAK_INFO = WS_UMUM_PREFIX + "cetakInfo.json";
	private static final String CETAK_INVOICE = WS_UMUM_PREFIX
			+ "cetakInvoice.json";
	private static final String GET_MASTER_KOLEKTIF = WS_UMUM_PREFIX
			+ "getMasterKolektif.json";
	private static final String LIHAT_HISTORY_TRANSAKSI = WS_UMUM_PREFIX
			+ "LihatHistoTrans.json";

	public static String doCetakInfo(String idPelanggan, String blnAwal,
			String blnAkhir) {
	...
	public static String doCetakInvoice(String idPelanggan, String blnAwal,
			String blnAkhir) {
		UrlBuilder builder = new UrlBuilder();
	...
	public static String getIdpelangganFromKontrakKontrol(String kontrak,
			String kontrol) {
		UrlBuilder builder = new UrlBuilder();
