...
public class clsJatelicon {
  ...
  public Map<String, Object> getInfoPelanggan(String sIdpel) {
    ...
    try {
      ...
      if (lMapData.size() > 0) {
        retValue.put("wsReturn",
            sIdpel + "," + lMapData.get(0).get("LBRLNS") + "," + lMapData.get(0).get("RPLNS") + ","
                + lMapData.get(0).get("LBRTGK") + "," + lMapData.get(0).get("RPTGK"));
      } else {
  ...
  public Map<String, Object> getNotul603(String sIdpel) {
    ...
    try {
      ...
      sql = " SELECT  ";
      sql +=
          " IDPELANGGAN, NOKONTRAK, NOKONTROL, NAMA, ALAMAT, NO_TUL601, TGL_TUL601,to_char(tgl_tul603,'yyyy-mm-dd')||'/TULVI-03/'||no_tul603 AS NO_TUL603, THBLREK_AKHIR,  ";
      sql +=
          " LEMBAR_603, TAGIHAN_603, TGL_PELUNASAN_603, NO_BA_BONGKAR, TGL_BA_BONGKAR, TGL_PELAKSANAAN_BONGKAR,  ";
      sql +=
          " NAMA_BONGKAR, STAND_LWBP_BONGKAR, STAND_WBP_BONGKAR, STAND_KVARH_BONGKAR, NO_PDL, TGL_PDL, THBL_PDL_BERHASIL, KETERANGAN ";
  ...
  public Map<String, Object> getPelangganKoreksi(String tIdpel, String tBlth, String sKdKoreksi) {
    ...
    try {
      ...
      if (sKdKoreksi == "A" || sKdKoreksi == "B" || sKdKoreksi == "C" || sKdKoreksi == "G") {
        sql =
            "SELECT BLTH, IDPEL, NOPEL,  KDKOREKSI, TGKOREKSI, STATUS,  PEMDA, NAMA, PNJ, NAMAPNJ,";
        sql =
            sql + " NOBANG, KETNOBANG, RT, RW, NODLMRT, KETNODLMRT, LINGKUNGAN, KODEPOS, IDTARIP, ";
        ...
        sql =
            sql
                + " SLAWBP, SAHWBP, SLAKVARH, SAHKVARH, SKVAMAX, FAKM, FAKMKVARH, FAKMKVAMAX, KWHLWBP, ";
        sql =
            sql + " KWHWBP, BLOK3, PEMKWH, KWHKVARH, KELBKVARH, RPLWBP, RPWBP, RPBLOK3, RPKVARH, ";
        sql = sql + " RPBEBAN, CTTLB, RPTTLB, RPPTL, RPTB, RPPPN, RPBPJU, RPTRAFO, RPSEWATRAFO, ";
        sql =
            sql
                + " RPSEWAKAP, KDANGSA, RPANGSA, KDANGSB, RPANGSB, KDANGSC, RPANGSC, RPMAT, RPPLN, ";
        sql =
            sql
                + " RPTAG, RPPRODUKSI, RPSUBSIDI, RPREDUKSI, RPINSENTIF, RPDISINSENTIF, RPBK1, RPBK2, RPBK3, ";
      ...
      if (lMapData.size() > 0) {
        ...
        if (lMapData.size() > 0) {
          if (lMapData.get(0).get("TGKOREKSI") == formatter.format(dDate)
              && lMapData.get(0).get("TGLBAYAR") == "") {
            ErrMsg = "Rekening sudah dikoreksi !";
          } else if (lMapData.get(0).get("TGKOREKSI") == formatter.format(dDate)
              && lMapData.get(0).get("TGLBAYAR") != "") {
  ...
  public Map<String, Object> getPelangganLunas(String sIdpel, String sBlth) {
  ...
  public Map<String, Object> setBatalLunasKoreksi(String sIdpel, String sBlth, String sPetugasLns,
      String sPetugasBatal, String sAlasan) {
    ...
    try {
      ...
      sql =
          "{ call Proc_Batal21_LunasJatelindo('" + sPetugasBatal + "','" + sIdpel + "','" + sBlth
              + "'," + "'" + sPetugasLns + "'" + ",'" + sAlasan + "','"
              + lMapData.get(0).get("TRANSAKSIID") + "','" + lMapData.get(0).get("KDPP")
              + "','21') }";
  ...
  public Map<String, Object> setBatalPelangganKorensi(String sIdpel, String sBlth,
      String sUserBatal, String sTglKoreksi, String sAlasan) {
  ...
  public Map<String, Object> setLunasKoreksi(String sIdpel, String sBlth, String sPetugas,
      String sKdpp, Integer dRptag, String sTglBayar, String sWktBayar, String sUnitLunas) {
    ...
    try {
      ...
      sql =
          "{ call Proc_21_LunasKoreksiJat('" + sKdpp + "','" + sTglBayar + "','" + sWktBayar + "',"
              + "'" + sPetugas + "'" + ",'" + sIdpel + "','12','21','" + sBlth + "',"
              + dRptag.toString() + ",'" + sUnitLunas + "','E') }";
  ...
  public Map<String, Object> setPelangganKoreksi(List<Map<String, String>> sRsXML,
      String sUserTrans, String sKDKoreksi) {
    ...
    try {
      ...
      if (sKDKoreksi == "A" || sKDKoreksi == "B" || sKDKoreksi == "C" || sKDKoreksi == "G") {
        ...
        if (Integer.parseInt(lMapData.get(0).get("RPTAG")) < Integer.parseInt(sRsXML.get(0).get(
            "RPTAG"))) {
          bSuplisi = true;
        }
