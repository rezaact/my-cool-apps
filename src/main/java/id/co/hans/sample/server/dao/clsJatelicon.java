...
public class clsJatelicon {
        ...
        try
        {
            ...
            if (lMapData.size() > 0) {
                ...
                if (lMapData.size() > 0) {
                    ...
                    } else if (lMapData.get(0).get("TGKOREKSI") == formatter.format(dDate) && !lMapData.get(0).get("TGLBAYAR").equals("")) {
                        ErrMsg = "Rekening koreksi sudah lunas !";
                    } else if (!lMapData.get(0).get("TGKOREKSI").equals("")) {
    ...
    public Map<String, Object> setBatalPelangganKorensi(String sIdpel,
        ...
        try
        {
            ...
            if (lMapData.size() > 0 ) {
                ...
                Map<String, Object> retClsBtl = new HashMap<String, Object>();
                List<Map<String, String>> dsResult = new ArrayList<Map<String , String>>();
    ...
    public Map<String, Object> setPelangganKoreksi(List<Map<String, String>> sRsXML,
        ...
        try
        {
            ...
            Map<String, String> mnewrow = new HashMap<String, String>();
            ...
            List<Map<String, String>> dsTrans = new ArrayList<Map<String, String>>();
            dsTrans.add(mnewrow);
