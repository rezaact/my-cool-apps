...
public class cls_Aplikasi {
  ...
  public Map<String, Object> login(String uname, String strData) {
    ...
    try {
      ...
      if (strData == "" || strData != "v.2.0.6") {
        throw new Exception(
            "Versi SIP3 yang anda gunakan sudah kadaluarsa, harap gunakan versi terbaru SIP 3. Versi terbaru SIP 3 adalah v.2.0.6, jika ada pertanyaan hubungi operator KD Dist. Jatim!");
      }
      ...
      sql =
          " select KODEPETUGAS, NAMAPETUGAS, JENISKELAMIN, NIP, UNIT, PETUGAS.UNITUP, KODEPP, KASIRID, USERNAME, PASSWORD, ROLEID, NOSKNOTADINAS, SKFROMDATE, SKENDDATE, TGLCATAT, CATATBY, TGLUPDATE, UPDATEBY, RIGHTSLOGIN, RIGHTSLOGINBY, LOGINFROMDATE, LOGINTHRUDATE, LOGINPASSTRUE, HOSTNAME, HOSTID, MACADDRESS, ";
      sql =
          sql
              + " nvl(unitup.nama,' ') as NAMAUNITUP from PETUGAS left join unitup on petugas.unitup = unitup.unitup where ";
      ...
      if (wsMenuData.get("wsByRefError") != "") {
